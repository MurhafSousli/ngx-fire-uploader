(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/observable/fromPromise'), require('rxjs/observable/from'), require('rxjs/observable/of'), require('rxjs/BehaviorSubject'), require('angularfire2/storage'), require('rxjs/operators/debounceTime'), require('rxjs/operators/combineAll'), require('rxjs/operators/concatMap'), require('rxjs/operators/switchMap'), require('rxjs/operators/takeUntil'), require('rxjs/operators/finalize'), require('rxjs/operators/map'), require('rxjs/operators/tap'), require('rxjs/observable/forkJoin'), require('rxjs/Subject'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define('@ngx-fire-uploader/core', ['exports', '@angular/core', 'rxjs/observable/fromPromise', 'rxjs/observable/from', 'rxjs/observable/of', 'rxjs/BehaviorSubject', 'angularfire2/storage', 'rxjs/operators/debounceTime', 'rxjs/operators/combineAll', 'rxjs/operators/concatMap', 'rxjs/operators/switchMap', 'rxjs/operators/takeUntil', 'rxjs/operators/finalize', 'rxjs/operators/map', 'rxjs/operators/tap', 'rxjs/observable/forkJoin', 'rxjs/Subject', '@angular/common'], factory) :
	(factory((global['ngx-fire-uploader'] = global['ngx-fire-uploader'] || {}, global['ngx-fire-uploader'].core = {}),global.ng.core,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.Rx,global.storage,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable,global.Rx,global.ng.common));
}(this, (function (exports,core,fromPromise,from,of,BehaviorSubject,storage,debounceTime,combineAll,concatMap,switchMap,takeUntil,finalize,map,tap,forkJoin,Subject,common) { 'use strict';
...
var UPLOADER_CONFIG = new core.InjectionToken('config');
var defaultConfig = {
    dropZone: true,
    paramName: null,
    uniqueName: true,
...
FireUploader.ctorParameters = function () { return [
    { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [UPLOADER_CONFIG,] },] },
]; };
...
var FileItem = /** @class */ (function () {
    function FileItem(file, _uploader) {
        ...
        this.snapshot$ = new BehaviorSubject.BehaviorSubject({});
        this.updateSnapshot({
            name: file.name,
            type: file.type,
            active: false,
...
var FireUploaderComponent = /** @class */ (function () {
    function FireUploaderComponent(_manager, _storage) {
        ...
        this.state$ = new BehaviorSubject.BehaviorSubject(this._initialState);
        this.updateRootState$ = new BehaviorSubject.BehaviorSubject({});
        this._cancelUpload$ = new Subject.Subject();
        ...
        this.removeEmitter = new core.EventEmitter();
        this.successEmitter = new core.EventEmitter();
        this.completeEmitter = new core.EventEmitter();
        this.valueEmitter = new core.EventEmitter();
        this.errorEmitter = new core.EventEmitter();
        this.activeEmitter = new core.EventEmitter();
        this.progressEmitter = new core.EventEmitter();
        this.resetEmitter = new core.EventEmitter();
    }
    FireUploaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.updateRootState$.pipe(debounceTime.debounceTime(50), map.map(function () {
    ...
    FireUploaderComponent.prototype.start = function () {
        ...
        if (!this._state.active && this._state.files.length) {
            from.from(this._state.files).pipe(map.map(function (file) { return processFile(file, _this.resizeWidth, _this.resizeHeight, _this.resizeMethod, _this.resizeQuality); }), combineAll.combineAll(), switchMap.switchMap(function (files) { return parallizeUploads(files, _this.parallelUploads); }), concatMap.concatMap(function (chunk) { return _this.uploadFiles(chunk); }), takeUntil.takeUntil(this._cancelUpload$), finalize.finalize(function () {
    ...
    FireUploaderComponent.prototype.uploadFiles = function (files) {
        ...
        return forkJoin.forkJoin.apply(void 0, __spread(chunk));
    };
...
FireUploaderComponent.propDecorators = {
    ...
    "paramName": [{ type: core.Input },],
    "uniqueName": [{ type: core.Input },],
    "placeholder": [{ type: core.Input },],
    "multiple": [{ type: core.Input },],
    "accept": [{ type: core.Input },],
    "parallelUploads": [{ type: core.Input },],
    "maxFiles": [{ type: core.Input },],
    "maxFileSize": [{ type: core.Input },],
    "autoStart": [{ type: core.Input },],
    "thumbs": [{ type: core.Input },],
    "thumbnailMethod": [{ type: core.Input },],
    "resizeMethod": [{ type: core.Input },],
    "resizeWidth": [{ type: core.Input },],
    "resizeHeight": [{ type: core.Input },],
    "resizeQuality": [{ type: core.Input },],
    "thumbWidth": [{ type: core.Input },],
    "thumbHeight": [{ type: core.Input },],
    "resizeMimeType": [{ type: core.Input },],
    "filesEmitter": [{ type: core.Output, args: ['files',] },],
    "removeEmitter": [{ type: core.Output, args: ['remove',] },],
    "successEmitter": [{ type: core.Output, args: ['success',] },],
    "completeEmitter": [{ type: core.Output, args: ['complete',] },],
    "valueEmitter": [{ type: core.Output, args: ['value',] },],
    "errorEmitter": [{ type: core.Output, args: ['error',] },],
    "activeEmitter": [{ type: core.Output, args: ['active',] },],
    "progressEmitter": [{ type: core.Output, args: ['progress',] },],
    "resetEmitter": [{ type: core.Output, args: ['reset',] },],
    "fileInput": [{ type: core.ViewChild, args: ['fileInput',] },],
    "hoverClass": [{ type: core.HostBinding, args: ['class.dragover',] },],
};
var DropZoneDirective = /** @class */ (function () {
    function DropZoneDirective() {
        this.dropZone = new core.EventEmitter();
...
DropZoneDirective.propDecorators = {
    "dropZone": [{ type: core.Output, args: ['dropZone',] },],
...
exports.FireUploaderModule = FireUploaderModule;
exports.FireUploaderComponent = FireUploaderComponent;
exports.FileItem = FileItem;
exports.ɵc = DropZoneDirective;
exports.ɵa = FireUploader;
exports.ɵb = UPLOADER_CONFIG;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-fire-uploader-core.umd.js.map
